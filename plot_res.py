...
data = pd.read_csv('beir_stats_output_top100.csv')
...
fig.suptitle("Comparación entre baseline y modelos de reranking", fontsize=20)
...
plt.tight_layout()
plt.subplots_adjust(top=0.92, bottom=0.1, hspace=0.7)
plt.show()
